...
const preVerifySummary={schemaVersion:1,batchId:job.jobId,generatedAt:new Date().toISOString(),before:{activeRecipes:snapshot.activeRecipeCount,scaleGate:beforeGate.status},candidateCount:generated.candidates.length,accepted:result.acceptedCount,rejected:result.rejectedCount,reviewBacklog:report.reviewBacklogCount,batchGate:report.batchGate.status,dispositions:report.dispositionCounts,jobNutrition:{energyKcal:job.energyKcal,proteinG:job.proteinG,fiberG:job.fiberG},generatorDiagnostics:generated.diagnostics};
await Promise.all([
