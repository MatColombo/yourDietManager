...
const updatedIntake=applyIndustrializedBatchToIntake({intake,job,report,registry}); await verifyIndustrializedBatchReport({result,report,pipelinePolicy,registry});
