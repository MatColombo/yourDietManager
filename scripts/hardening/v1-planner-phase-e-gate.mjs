...
check('phase-e-version',pkg.version==='1.0.0-rc.32'&&constants.includes("APP_VERSION = '1.0.0-rc.32'"),`package=${pkg.version}`);
...
check('pwa-shell-phase-e',sw.includes('ydm-shell-v35-')&&sw.includes('src/services/manualAcceptanceService.js')&&sw.includes('src/ui/manualAcceptancePage.js'),'shell v35 precaches Phase E harness');
