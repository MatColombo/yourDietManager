...
check('plan-recipe-route', planUi.includes('href: `/recipes/${encodeURIComponent(recipe.recipeId)}?version=') && !planUi.includes('/recipes/?id='), 'plan recipe links use /recipes/:recipeId');
