...
const SHELL_CACHE = `ydm-shell-v56-${CACHE_SCOPE_KEY}`;
const DATA_CACHE = `ydm-data-v25-${CACHE_SCOPE_KEY}`;
...
const SHELL = [
  ...
  'src/services/manualAcceptanceService.js', 'src/services/nutritionalAffinityService.js', 'src/services/planCandidateService.js', 'src/services/planGenerationService.js', 'src/services/generationTuningService.js', 'src/services/plannerValidationService.js', 'src/services/effectivePlanService.js', 'src/services/calendarPlanEditorService.js', 'src/services/operationHistoryService.js', 'src/services/shoppingService.js',
