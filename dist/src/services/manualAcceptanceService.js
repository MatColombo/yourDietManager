...
export const MANUAL_ACCEPTANCE_CASES = Object.freeze([
  ...
  { id:'energy-2000', group:'energy', required:true, title:'2000 kcal strict plan', hint:'Generate 7–14 days at ±2%; inspect Planner Lab uniqueness/repeat metrics and meal quality. Exact recipe reuse within 3 days should be absent in the standard quality run.' },
  { id:'energy-2600', group:'energy', required:true, title:'2600 kcal strict quality stress', hint:'Generate 14 days at 2600 kcal with ±2%; verify fixed servings, at least 70% unique recipe components and zero exact-recipe repeat pairs within 3 days.' },
